...
export const AvailableSeatsEditor = ({ seatsAvailable, seatsAllocated, note, open, triggerClose, perfId }: AvailableSeatsEditorProps) => {
  ...
  return (
    <StyledDialog title={'Set Available Seats'} open={open} onClose={() => triggerClose(false)}>
      <form onSubmit={handleOnSubmit}>
        <FormInputNumeric min={seatsAllocated} name="Seats" label="Seats Available" value={inputs.Seats} onChange={handleSeatChange} />
