...
export default function Historyload() {
    ...
    const handleOnSubmit = async (e) => {
        ...
        handleServerResponse(
            true,
            'Thank you, your submitting the file will now be processed.',
        );
      //  handleClose()
    };
        ...
        <div className={"flex bg-pink-50 w-9/12 p-5"}>
            ...
            <div
                ...
                <div className={"mb-1"}>
                    ...
                    <p>Select a CSV file to upload. This will overwrite existing sales data for the specified
                        ‘Show/Tour, Venue, Date’. If data does not currently exist for that ‘Show/Tour, Venue,
                        Date’ then the information in the CSV file will be uploaded to the system without
                        affecting current data.</p>
                </div>
                    ...
                    <div className="columns-1">
                        <div
                            ...
                            <div className="mt-1 sm:col-span-2 sm:mt-0">
                                <label htmlFor="formFile" className="form-label inline-block mb-2 text-gray-700">Default
