      ...
      <table className=" min-w-full divide-y divide-gray-300">
        <thead className=" text-white">
          <tr className="bg-primary-green">
            ...
            <th scope="col" className="px-3 py-3.5 rounded-tr-md text-left text-sm font-semibold text-white">
              Actions
            </th>
          </tr>
        </thead>
        <tbody className="divide-y divide-gray-200 bg-white">
          {activitiy.map((venue) => (
            <tr key={venue.production}>
              ...
              <td className="hidden px-3 py-4 text-sm text-gray-500 sm:table-cell">{venue.start}</td>
              <td className="px-3 py-4 text-sm text-gray-500">{venue.end}</td>
              <td className="px-3 py-4 text-sm text-gray-500">{venue.followup}</td>
