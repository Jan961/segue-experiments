        ...
        return (
            <div>
                ...
                <CopyToClipboard text={emailAddress}
                    ...
                    <span>Your unique email address is <FontAwesomeIcon icon={faEnvelopeOpen}/> {email}</span>
                </CopyToClipboard>

                <CopyToClipboard text={emailAddress}
                                 onCopy={() => setCopied(true)}>
                    <button>
                        <FontAwesomeIcon icon={faCopy}/> {copied ? <span style={{color: 'green'}}>Copied.</span> :
                        <span>Copy</span>}
                        - forward sales data here for automatic parsing
                    </button>
                </CopyToClipboard>
