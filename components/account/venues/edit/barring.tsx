        ...
        <form onSubmit={handleOnSubmit}>
          <div className="grid grid-cols-2 gap-2 w-screen px-20">
            ...
            <div>
              ...
              Barring Clause List (DO with BARRING) Include a new form with the barring venue venue data
            </div>
            <div></div>
          </div>
