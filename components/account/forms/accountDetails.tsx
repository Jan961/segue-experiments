      ...
      <div className="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8">
          <div>
            ...
            <p className="mt-2 text-center text-sm text-gray-600">Update your company details below</p>
          </div>
            ...
            <div>
              <fieldset id="Account">
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div>
                    <label htmlFor="company_website" className="">
                      Company Website
                    </label>
                  ...
                  <div>
                    <label htmlFor="address_line_2" className="">
                      Address Line 2
                    </label>
                    <input
                      id="address_line_2"
                  ...
                  <div>
                    <label htmlFor="vatRegistered" className="">
                      VAT Registered{' '}
                    </label>
                  ...
                  <div>
                    <label htmlFor="address_line_3" className="">
                      Address Line 3
                    </label>
                    <input
                      id="address_line_3"
                  ...
                  <div>
                    <label htmlFor="county" className="">
                      County
                    </label>
                    <input
                      id="county"
