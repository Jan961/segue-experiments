...
className="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 sm:table-cell"
    ...
    {activities.map((activity) => (
        ...
        <td className="hidden px-3 py-4 text-sm text-gray-500 sm:table-cell">{activity.created} - {activity.followup}</td>
...
<button className={"inline-flex items-center mt-5 rounded border border-gray-300 bg-white px-2.5 py-1.5 text-xs font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"}>Add Activity </button>
