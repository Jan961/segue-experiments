            ...
            <div className="grid grid-cols-2 gap-2">
                <div>
                    ...
                    <input type="email" name="email" id="email"
                           ...
                           placeholder="Your email" value={Account.email}/>


                </div>
                <div>
                    <label htmlFor="name" className="sr-only">Your name</label>
                    <input type="text" name="name" id="name" placeholder="Your Name" value={Account.name}
                ...
                <div>
                    <label htmlFor="password_confrm" className="sr-only">Confirm Password</label>
                    <input type="password" name="password_confrm" id="password_confrm" placeholder="Password Repeat"
                           className="block w-full min-w-0 flex-1 rounded-none rounded-r-md border-gray-300 px-3 py-2 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"/>
                </div>
