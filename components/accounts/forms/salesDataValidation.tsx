            ...
            <div className="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div className="w-full max-w-md space-y-8">
                    <div>
                        ...
                        <h1 className="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Update Account Sales Data Validation</h1>
                        ...
                        <div>
                            <fieldset id="Account">
                                <div className="grid grid-cols-1 gap-2">
                                    ...
                                    <div>
                                        <label htmlFor="lowSeatCount" className="">Seat Count is Lass than Previous by</label>
                                        <input id="lowSeatCount"
                                               type="number"
                                               name="lowSeatCount"
                                    ...
                                    <div>
                                        <label htmlFor="seatPerCentIncrease" className="">Seat Count increase Percentage (%)</label>
                                        <input id="seatPercentageIncrease"
                                               type="number"
                                               name="telephone"
                                               onChange={handleOnChange}
                                    ...
                                    <div>
                                        <label htmlFor="HighSeatCount" className="">Seat Count Increase by </label>
                                        <input id="HighSeatCount"
                                               type="number"
                                               name="HighSeatCount"
                                               onChange={handleOnChange}
                                               required
                                    ...
                                    <div>
                                        <label htmlFor="seatPercentageLowerIncrease" className="">Seat Count increase Percentage lower bound (%)</label>
                                        <input id="seatPercentageLowerIncrease"
                                               type="number"
                                    ...
                                    <div>
                                        <label htmlFor="reservedSeatPercentageIncrease" className="">Reserved Seat Count increase Percentage (%)</label>
                                        <input id="reservedSeatPercentageIncrease"
                                               type="number"
