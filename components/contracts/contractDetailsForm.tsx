...
export const Label = (props: any) => {
  return (<span { ...props } className={classNames(`${props.className} text-primary-pink font-bold w-full`)}>{ props.children }</span>)
}
    ...
    if (activeContractData.length > 0) {
      ...
      setBookingDetails({
        ...
        ContractReturnDate: formatFormDate(
          c.ContractReturnDate
        ),
        ContractReceivedBackDate: formatFormDate(
          c.ContractReceivedBackDate
        ),
