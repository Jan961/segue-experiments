  ...
  return (
    <div className="flex-col items-center pb-3">
      <p className="text-2xl font-bold w-full text-center">
        Bulk update tasks ({taskIdArray.length} tasks)
      </p>
      ...
      <div className="overflow-hidden bg-white shadow sm:rounded-lg">
        ...
        <div className="border-t flex justify-center my-4 border-gray-200" >
        {renderInput(bulkActionField)}
        </div>
        </div>
