...
const venueSchema = Yup.object().shape({
  ...
  primaryPostCode: Yup.string().required('Primary Address Postcode is a required field'),
  primaryTown: Yup.string().required('Primary Address Town is a required field'),
});
