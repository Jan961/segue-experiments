  ...
  return (
    <>
      ...
      <div className="flex flex-auto flex-col bg-yellow-100 w-9/12">
        <div className="flex ">Manage Custom venue data</div>
        <div>
          Segue provides a rich database of venue information out of the box. If you would like to add your own venues,
