...
const Tooltip: React.FC<TooltipProps> = ({ 
  ...
  const getArrowStyle = () => {
    switch (position) {
      case 'top':
        return 'absolute top-0 left-1/2 -mt-3 -ml-2 w-0 h-0 border-t-[10px] border-l-[10px] border-r-[10px] border-transparent border-t-' + bgColorClass;
      case 'bottom':
        return 'absolute bottom-0 left-1/2 -mb-3 -ml-2 w-0 h-0 border-b-[10px] border-l-[10px] border-r-[10px] border-transparent border-b-' + bgColorClass;
      case 'right':
        return 'absolute top-1/2 right-0 -mr-4 -mt-2 w-0 h-0 border-t-[10px] border-b-[10px] border-r-[10px] border-transparent border-r-' + bgColorClass;
      case 'left':
        return 'absolute top-1/2 left-0 -ml-4 -mt-2 w-0 h-0 border-t-[10px] border-b-[10px] border-l-[10px] border-transparent border-l-' + bgColorClass;
      default:
        return 'absolute top-0 left-1/2 -mt-3 -ml-2 w-0 h-0 border-t-[10px] border-l-[10px] border-r-[10px] border-transparent border-t-' + bgColorClass;
    }
  };
