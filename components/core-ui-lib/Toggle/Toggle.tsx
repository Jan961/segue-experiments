  ...
  return (
    <Switch
      ...
      className={classNames(
        className,
        'relative inline-flex shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring-2  focus-visible:ring-white/75 w-7 h-[19px] bg-disabled-button',
      )}
    >
