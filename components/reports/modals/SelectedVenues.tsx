                ...
                <form onSubmit={handleOnSubmit}>
                  ...
                  <div className="flex flex-col space-y-2 mt-4">
                    ...
                    >
                      ...
                      <option key="MARKETING PLANS RECEIVED" value="MARKETING PLANS RECEIVED">
                        MARKETING PLANS RECEIVED
                      </option>
                      <option key="MARKETING PLANS NOT RECEIVED" value="MARKETING PLANS NOT RECEIVED">
                        MARKETING PLANS NOT RECEIVED
                      </option>
                      <option key="CONTACT INFO RECEIVED" value="CONTACT INFO RECEIVED">
                        CONTACT INFO RECEIVED
                      </option>
                      <option key="CONTACT INFO NOT RECEIVED" value="CONTACT INFO NOT RECEIVED">
                        CONTACT INFO NOT RECEIVED
                      </option>
                      <option key="PRINT REQUIREMENTS RECEIVED" value="PRINT REQUIREMENTS RECEIVED">
                        PRINT REQUIREMENTS RECEIVED
                      </option>
                      <option key="PRINT REQUIREMENTS NOT RECEIVED" value="PRINT REQUIREMENTS NOT RECEIVED">
