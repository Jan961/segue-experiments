...
/**
        let nextId = 1;
        setPres( // Replace the state
            [ // with a new array
                ...pres, // that contains all the old items
                { Id: nextId++ , data:  "dielx" } // and one new item at the end
            ])
 ...
 */
    ...
    const exportFile = useCallback(() => {
        ...
        utils.book_append_sheet(wb, ws, "MasterPlan");
        writeFileXLSX(wb, "MasterPlanReport.xlsx");
    }, [pres]);
