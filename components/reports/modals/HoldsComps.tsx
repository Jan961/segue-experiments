...
export default function HoldsComps(){
    ...
    async function buildReport(){
        ...
        axios({
            ...
            .then((response) => {
                ...
                exportedDate.value =  dateService.dateStringToSimple(new Date()) + " "  + dateService.timeNow()
                ...
                for(let performance of response.data){
                    ...
                    worksheet.getCell(rowCount, 4).value = dateService.dateStringToSimple(performance.f6)
