                  ...
                  <div className="px-4 border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    ...
                    <form onSubmit={handleOnSubmit}>
                      ...
                      <div className="flex flex-col space-y-2 mt-4">
                        <span>Tour Dates {dateToSimple(inputs.tourStartDate)} to {dateToSimple(inputs.tourEndDate)}</span>
                      </div>
                      <div className="flex flex-col space-y-2 mt-4">
                        ...
                        <select
                          ...
                          {
                            tourWeeks.map((week) => (
                              <option key={week.MondayDate} value={`${week.MondayDate}`}>{week.Description || dateToSimple(week.MondayDate)}</option>
                            ))
                          }
                        </select>
                      </div>
