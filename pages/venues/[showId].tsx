        ...
        <div className="w-full px-2 md:px-8 lg:px-12">
          <section className="flex flex-row justify-between pb-32">
            <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-4xl mt-5 text-left">
              <span className="block xl:inline text-primary-orange">ST1/22 - Admin (Venues)</span>
            </h1>
          ...
          <section>
            <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-4xl mt-5 text-left">
              <span className="block xl:inline text-primary-orange">Manage Custom Venue Data</span>
            </h1>
            <p className="mt-6">Segue provides a rich database of venue information out of the box. </p>
            <p> If you would like to add your own venues, please enter those below</p>
          </section>
