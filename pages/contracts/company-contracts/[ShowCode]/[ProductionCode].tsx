    ...
    <Layout title="Contracts | Segue" flush>
      <div className="mb-8">
        <CompanyContractFilters
          permissions={{
            disableNewPerson: !permissions.includes('ADD_NEW_PERSON_CREATIVE'),
            disableNewContract: !permissions.includes('ADD_NEW_CREATIVE_CONTRACT'),
          }}
        />
      </div>
      <CompanyContractsTable
        rowData={rows}
        permissions={{
          editRow: permissions.includes('EDIT_CONTRACT_CREATIVE'),
          savePDF: permissions.includes('EXPORT_CREATIVE_CONTRACT'),
          changeStatus: permissions.includes('EDIT_CREATIVE_CONTRACT_STATUS_DROPDOWNS'),
          editPerson: permissions.includes('EDIT_PERSON_DETAILS_CREATIVE'),
        }}
      />
    </Layout>
  );
