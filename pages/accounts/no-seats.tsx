...
const Index = () => (
    ...
    <LayoutAccountLocked title="Account | Segue">
        ...
        <p>Sorry, your account cannot be loaded, Your company has no Licences available. Please contact your account
        administrator to activate more licences, to log out and try again later</p>
