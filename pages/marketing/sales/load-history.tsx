...
import LoadSalesHistoryFilters from 'components/marketing/LoadSalesHistoryFilters';
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
  ...
  const productionJump = await getProductionJumpState(ctx, 'marketing/sales/load-history', accountId);
