...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  try {
    ...
    const tourPerformanceSummary: Partial<ScheduleView>[] =
      await prisma.$queryRaw`SELECT * from TourPerformanceSummaryView where TourId=${FullTourCode}`;
    ...
    const entryTypeSummary = tourSummary
