...
export default async function handle(req, res) {
    ...
    let query =  "SELECT VenueCurrency, Symbol, ConversionRate, TourWeekNum, Sum(Value) As Totla, Sum(RunDeatsSold) As TotlaRunSeatsSold, Sum(TotalRunSeats) As TotalSeats " +
        "FROM SalesSummary  " +
