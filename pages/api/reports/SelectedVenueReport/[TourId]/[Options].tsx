...
export default async function handle(req, res) {
    ...
    let query = "SELECT FullTourCode, ShowName,  ShowDate,  VenueCode,  VenueName, Town, BookingStatus, OnSale, OnSaleDate, MarketingPlanReceived,  ContactInfoReceived,  PrintReqsReceived  FROM TourVenueView  WHERE (NOT VenueId IS NULL) "
