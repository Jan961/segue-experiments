...
export const dealMemoMapper = (dealMemo: DealMemoContractFormData) => {
  return {
    ...
    AgreementDate: convertDate(dealMemo.AgreementDate),
    ...
    PrintDelUseVenueAddressline: dealMemo.PrintDelUseVenueAddressline,
    SellMerch: dealMemo.SellMerch,
    SellNotes: dealMemo.SellNotes,
    ...
    NumDressingRooms: dealMemo.NumDressingRooms,
