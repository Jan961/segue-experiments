...
!(function (e) {
        ...
        if (
          (O.time &&
            (j = (function (e) {
              ...
              if ((t = b.exec(e)))
                return (n = parseInt(t[1], 10)), (r = parseFloat(t[2].replace(',', '.'))), (n % 24) * i + r * a;
              if ((t = _.exec(e))) {
    ...
    (function (e, r) {
      ...
      function d(e, t) {
        if (!e)
          throw new Error(
            '[mobx] ' +
              (t || 'An invariant failed, however the error is obfuscated because this is an production build.'),
          );
      }
      Object.freeze(u);
      function p(e) {
        ...
        return function () {
          var n,
            r = function (r, o, a, s) {
              ...
              return (
                (r[N][o] = { prop: o, propertyCreator: t, descriptor: a, decoratorTarget: r, decoratorArguments: n }),
                M(o, e)
              );
            };
        ...
        wt = (function () {
          ...
          return (
            ...
            (e.prototype._updateHasMapEntry = function (e, t) {
              ...
              return (
                n ? n.setNewValue(t) : ((n = new oe(t, R, this.name + '.' + e + '?', !1)), this._hasMap.set(e, n)), n
              );
            }),
                ...
                nt(function () {
                  if (v(e))
                    ...
                    if (e.constructor !== Map)
                      return f('Cannot initialize from classes that inherit from Map: ' + e.constructor.name);
        ...
        kt = (function () {
          ...
          return (
            ...
            (e.prototype.add = function (e) {
              var t = this;
              if ((ce(this._atom), at(this)) && !(o = lt(this, { type: 'add', object: this, newValue: e })))
                return this;
              if (!this.has(e)) {
                nt(function () {
            ...
            (e.prototype.addComputedProp = function (e, t, n) {
              ...
              (n.name = n.name || this.name + '.' + t),
                ...
                (e === a ||
                  ((r = e),
                  (o = t),
                  !(i = Object.getOwnPropertyDescriptor(r, o)) || (!1 !== i.configurable && !1 !== i.writable))) &&
                  Object.defineProperty(
                    e,
                    t,
                    (function (e) {
      ...
      function Tt(e, t, n) {
        if ((void 0 === t && (t = ''), void 0 === n && (n = I), Object.prototype.hasOwnProperty.call(e, x)))
          return e[x];
  ...
  function (e, t, n) {
    ...
    e.exports = function (e) {
      if (null == e) return !0;
      if (s(e) && (a(e) || 'string' == typeof e || 'function' == typeof e.splice || l(e) || c(e) || i(e)))
        return !e.length;
      var t = o(e);
      ...
      (function (e) {
        ...
        function x(e, t, n, r) {
          ...
          function v() {
            ...
            return (
              S.relevance > 0 && (C += t.relevance), e && (O[S.subLanguage] = t.top), h(t.language, t.value, !1, !0)
            );
          }
          function g() {
        ...
        function O(e) {
          ...
          h(a) ||
            ...
            (r = a ? x(a, i, !0) : E(i)),
            (n = g(t)).length &&
              (((o = document.createElementNS('http://www.w3.org/1999/xhtml', 'div')).innerHTML = r.value),
              (r.value = y(n, g(o), i))),
            (r.value = k(r.value)),
            (e.innerHTML = r.value),
          ...
          return (o.Chartist =
                ...
                (n.extend = function (e) {
                  ...
                  for (e = e || {}, t = 1; t < arguments.length; t++)
                    for (var i in (r = arguments[t]))
                      (o = r[i]),
                        (e[i] = 'object' != typeof o || null === o || o instanceof Array ? o : n.extend(e[i], o));
                  return e;
                }),
                  ...
                  return function (t, o) {
                    for (var i, a, s, l = new n.Svg.Path(), u = 0; u < t.length; u += 2) {
                      var c = t[u],
                        ...
                        p = o[u / 2];
                      void 0 !== p.value
                        ? (void 0 === s ? l.move(c, f, !1, p) : l.curve(i + d, a, c - d, f, c, f, !1, p),
                          (i = c),
                          (a = f),
                          (s = p))
            ...
            (function (e, t, n) {
              ...
              function o(e, t) {
                ...
                var i = function () {
                  ...
                  return (
                    (e = this === n ? Object.create(o) : this), t.apply(e, Array.prototype.slice.call(arguments, 0)), e
                  );
                };
                    ...
                    function (o) {
                      function i(e, t) {
                        var i,
                          ...
                          l = {};
                        e.easing &&
                          ((s = e.easing instanceof Array ? e.easing : n.Svg.Easing[e.easing]), delete e.easing),
            ...
            (function (e, t, n) {
              ...
              function d(e, t, n, r, o, a, s, l) {
                return (
                  i('C', { x1: +e, y1: +t, x2: +n, y2: +r, x: +o, y: +a }, this.pathElements, this.pos++, s, l), this
                );
              }
                  ...
                  t.raw.series.forEach(
                    function (r, a) {
                      ...
                      l.attr({ 'ct:series-name': r.name, 'ct:meta': n.serialize(r.meta) }),
                        l.addClass(
                          [e.classNames.series, r.className || e.classNames.series + '-' + n.alphaNumerate(a)].join(
                            ' ',
                          ),
                        );
                      var c = [],
                  ...
                  t.raw.series.forEach(
                    function (r, o) {
                      ...
                      (i =
                        ...
                        s.addClass(
                          [e.classNames.series, r.className || e.classNames.series + '-' + n.alphaNumerate(o)].join(
                            ' ',
                          ),
                        ),
                    ...
                    function (r, i) {
                      if (0 !== u.normalized.series[i] || !e.ignoreEmptyValues) {
                        c[i].attr({ 'ct:series-name': r.name }),
                          c[i].addClass(
                            [e.classNames.series, r.className || e.classNames.series + '-' + n.alphaNumerate(i)].join(
                              ' ',
                            ),
                          );
  ...
  function (e, t, n) {
    ...
    function Rt(e, t) {
      e.blockedOn === t &&
        ((e.blockedOn = null), bt || ((bt = !0), i.unstable_scheduleCallback(i.unstable_NormalPriority, It)));
    }
    function zt(e) {
      function t(t) {
        return Rt(t, e);
    ...
    function Xr(e, t) {
      ...
      return Gr || null == $r || $r !== fn(n)
        ...
        : ('selectionStart' in (n = $r) && vn(n)
          ...
          Qr && Vr(Qr, n)
            ? null
            : ((Qr = n), ((e = Qn.getPooled(Yr.select, qr, e, t)).type = 'select'), (e.target = $r), Bn(e), e));
    }
    var Kr = {
        eventTypes: Yr,
    ...
    function So(e, t, n) {
      ...
      n ? ((e = Eo(e, t, yo)), (r.__reactInternalMemoizedMergedChildContext = e), po(go), po(vo), ho(vo, e)) : po(go),
        ho(go, n);
    }
    ...
    function Ji(e, t, n, r, o, i) {
      ...
      if (((Vi.current = _a), (t = null !== qi && null !== qi.next), (Yi = 0), (Qi = qi = $i = null), (Gi = !1), t))
        throw Error(a(300));
      return e;
    }
    function Zi() {
    ...
    function al(e, t) {
      ...
      if (0 !== n) {
        ...
        if ((El(), (e === js && n === As) || cl(e, n), null !== Ds)) {
          ...
          if (null === Ds)
            switch (
              ((o = e.finishedWork = e.current.alternate), (e.finishedExpirationTime = n), (r = Is), (js = null), r)
            ) {
              case Ns:
              case 1:
                throw Error(a(345));
      ...
      do {
        ...
        if (((e = Ds.return), 0 == (2048 & Ds.effectTag))) {
          ...
          null !== e &&
            ...
            null !== Ds.lastEffect &&
              (null !== e.lastEffect && (e.lastEffect.nextEffect = Ds.firstEffect), (e.lastEffect = Ds.lastEffect)),
            1 < Ds.effectTag &&
              (null !== e.lastEffect ? (e.lastEffect.nextEffect = Ds) : (e.firstEffect = Ds), (e.lastEffect = Ds)));
        } else {
              ...
              if (u && 0 !== u.rangeCount) {
                ...
                t: for (;;) {
                  ...
                  for (;;) {
                    if (g === s) break t;
                    if (
                      (y === l && ++m === c && (p = d), y === f && ++v === u && (h = d), null !== (b = g.nextSibling))
                    )
                      break;
                    y = (g = y).parentNode;
                  }
      ...
      switch (((t.expirationTime = 0), t.tag)) {
        ...
        case 3:
          ...
          if (
            ...
            if (
              ((o = t.stateNode.hydrate) && ((Sa = Sn(t.stateNode.containerInfo.firstChild)), (ka = t), (o = Oa = !0)),
              o)
            )
  ...
  function (e, t, n) {
        ...
        (r = [
          {
            ...
            value: function () {
              ...
              return (
                !!a &&
                o.a.createElement('i', { className: s, dangerouslySetInnerHTML: { __html: '&#x'.concat(a, ';') } })
              );
            },
          },
        ]) && fe(n.prototype, r),
        ...
        return Object(ge.o)(function () {
          if (((o = o || '<<anonymous>>'), (a = a || r), null == n[r])) {
            if (t) {
              ...
              return new Error(
                'The ' + i + ' `' + a + '` is marked as required in `' + o + '`, but its value is `' + s + '`.',
              );
            }
            return null;
          }
    ...
    function et(e, t) {
      for (var n = Ke(e, t), r = arguments.length, o = new Array(r > 2 ? r - 2 : 0), i = 2; i < r; i++)
        o[i - 2] = arguments[i];
    ...
    if (
      'object' ===
      ('undefined' == typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__ ? 'undefined' : ye(__MOBX_DEVTOOLS_GLOBAL_HOOK__))
    ) {
                                ...
                                !!n &&
                                  n.map(function (e) {
                                    return o.a.createElement(
                                      ...
                                      {
                                        key: e.uuid,
                                        className: pn('list', 'main', { 'no-tests': !e.tests || 0 === e.tests.length }),
                                      },
                                      !!e.suites &&
                ...
                return o.a.createElement(
                  ...
                  o.a.createElement(
                    ...
                    o.a.createElement(
                      ...
                      p && ((e = 'stop'), (t = 'skipped')),
                      h &&
                        ((e = f ? 'error_outline' : s.match(/^"before/) ? 'rotate_left' : 'rotate_right'),
                        (t = 'hook')),
            ...
            ((n = jr(this, (e = Dr(t)).call.apply(e, [this].concat(i)))).renderVideo = function (e, t, n) {
              ...
              return o.a.createElement(
                ...
                r &&
                  o.a.createElement(
                    'a',
                    { href: a, className: Rr('video-link'), rel: 'noopener noreferrer', target: '_blank' },
                    a,
                  ),
              );
            }),
                ...
                return o.a.createElement(
                  ...
                  o.a.createElement(
                    ...
                    o.a.createElement(
                      ...
                      (y || E || k) &&
                        o.a.createElement(Or, { uuid: p, tests: c, beforeHooks: f, afterHooks: d, enableCode: i }),
                      P(),
                    ),
                  ),
                );
    ...
    (mo.propTypes = { suites: l.a.array, enableChart: l.a.bool, enableCode: l.a.bool, main: l.a.bool }),
