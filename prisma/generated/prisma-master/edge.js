...
const config = {
  generator: {
    ...
    output: {
      value:
        'C:\\Users\\Ashok Reddy M\\Dropbox\\My PC (DESKTOP-8DBPP2F)\\Desktop\\Cypress\\myBranch\\segue\\prisma\\generated\\prisma-master',
      fromEnvVar: null,
    },
    config: {
      engineType: 'library',
    ...
    sourceFilePath:
      'C:\\Users\\Ashok Reddy M\\Dropbox\\My PC (DESKTOP-8DBPP2F)\\Desktop\\Cypress\\myBranch\\segue\\prisma\\schema_master.prisma',
    isCustomOutput: true,
  },
  relativeEnvPaths: {
    rootEnvPath: null,
...
config.injectableEdgeEnv = () => ({
  parsed: {
    MASTER_DATABASE_URL:
      (typeof globalThis !== 'undefined' && globalThis['MASTER_DATABASE_URL']) ||
      (typeof process !== 'undefined' && process.env && process.env.MASTER_DATABASE_URL) ||
      undefined,
  },
});
