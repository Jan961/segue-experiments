...
function Re() {
  ...
  return typeof Netlify == 'object'
    ...
    ? 'lagon'
    : ((i = (n = globalThis.process) == null ? void 0 : n.release) == null ? void 0 : i.name) === Ye
    ? 'node'
    : globalThis.Bun
    ? 'bun'
    : globalThis.fastly
...
h.logarithm = h.log = function (e) {
  ...
  if (
    ((w = !1), (u = a + g), (o = B(f, u)), (t = n ? se(c, u + 10) : B(e, u)), (l = S(o, t, u, 1)), x(l.d, (r = a), d))
  )
    do
...
h.modulo = h.mod = function (e) {
  ...
  return (
    ...
    !i.d || !e.s || (e.d && !e.d[0])
      ...
      : ((w = !1),
        t.modulo == 9 ? ((n = S(i, e.abs(), 0, 3, 1)), (n.s *= e.s)) : (n = S(i, e, 0, t.modulo, 1)),
        (n = n.times(e)),
        (w = !0),
        i.minus(n))
  );
...
h.toDecimalPlaces = h.toDP = function (e, n) {
  var i = this,
    t = i.constructor;
  return (
    (i = new t(i)), e === void 0 ? i : (_(e, 0, $), n === void 0 ? (n = t.rounding) : _(n, 0, 8), p(i, e + i.e + 1, n))
  );
};
h.toExponential = function (e, n) {
  ...
  return (
    e === void 0
      ? (i = F(t, !0))
      : (_(e, 0, $), n === void 0 ? (n = r.rounding) : _(n, 0, 8), (t = p(new r(t), e + 1, n)), (i = F(t, !0, e + 1))),
...
h.toPower = h.pow = function (e) {
  ...
  return (
    (i = C(+u, f)),
    (n = i == 0 || !isFinite(i) ? b(f * (Math.log('0.' + O(u.d)) / Math.LN10 + u.e + 1)) : new l(i + '').e),
...
h.toSignificantDigits = h.toSD = function (e, n) {
  var i = this,
    t = i.constructor;
  return (
    e === void 0 ? ((e = t.precision), (n = t.rounding)) : (_(e, 1, $), n === void 0 ? (n = t.rounding) : _(n, 0, 8)),
    p(new t(i), e, n)
  );
};
h.toString = function () {
          ...
          (d = 0),
            ...
            f < 0
              ? ((Y = E[0]),
                ...
                A < P && N.unshift(0),
                i(E, N, P, l),
                f == -1 && ((P = E.length), (f = n(k, E, T, P)), f < 1 && (d++, i(E, T < P ? y : k, P, l))),
                (P = E.length))
              : f === 0 && (d++, (E = [0])),
            (q[a++] = d),
...
function p(e, n, i, t) {
  ...
  e: if (n != null) {
    ...
    if (
      (s == 0
        ? ((a.length = d), (u = 1), d--)
        : ((a.length = d + 1), (u = C(10, m - s)), (a[d] = o > 0 ? ((c / C(10, r - o)) % C(10, o) | 0) * u : 0)),
      f)
    )
      for (;;)
        if (d == 0) {
...
function Ee(e, n) {
  ...
  for (n == null ? ((w = !1), (l = v)) : (l = n), u = new d(0.03125); e.e > -2; ) (e = e.times(u)), (a += 5);
  for (t = ((Math.log(C(2, a)) / Math.LN10) * 2 + 5) | 0, l += t, i = s = o = new d(1), d.precision = l; ; ) {
    if (
      ...
      if (n == null)
        if (f < 3 && x(o.d, l - t, g, f)) (d.precision = l += 10), (i = s = u = new d(1)), (c = 0), f++;
...
function ke(e, n, i, t) {
  var r,
    ...
    v = i !== void 0;
  if (
    (v ? (_(i, 1, $), t === void 0 ? (t = g.rounding) : _(t, 0, 8)) : ((i = g.precision), (t = g.rounding)),
    !e.isFinite())
  )
    c = Ve(e);
  else {
    for (
      c = F(e),
        ...
        o >= 0 &&
          ((c = c.replace('.', '')), (d = new g(1)), (d.e = c.length - o), (d.d = ie(F(d), 10, r)), (d.e = d.d.length)),
        a = ie(c, 10, r),
        s = l = a.length;
      a[--l] == 0;
    ...
    if (!a[0]) c = v ? '0p+0' : '0';
      ...
      if (
        (o < 0
          ? s--
          : ((e = new g(e)), (e.d = a), (e.e = s), (e = S(e, d, i, t, 0, r)), (a = e.d), (s = e.e), (f = Te)),
        (o = a[i]),
        (u = r / 2),
        (f = f || a[i + 1] !== void 0),
        (f =
